...
##vector_name is a vector with the names in name_order (so names are listed in descending order of total amount given to them)
vector_name <- unique(name_order$cand_name)

##name_df puts vector_name into a dataframe
...
ggplot(all_name, aes(x = transaction_type, y = total, fill = transaction_type)) +
  ...
  labs(x = "Transaction type", y = "Total amount given") +
