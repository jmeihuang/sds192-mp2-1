...
Store all the *unique* candidate IDs in the data frame as a vector and map the function that produces the bar graph on all of them: 

```{r, message = FALSE}
candIDVector <- unique(fltr_cand$cand_name)
